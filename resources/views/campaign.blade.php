        ...
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                <div class="flex flex-col md:flex-row">
                    ...
                    {{-- Right: copy + image tabs --}}
                    <div class="flex-1 p-7" x-data="{ tab: 'copy' }">
                        {{-- Tab switcher --}}
                        <div class="flex items-center gap-1 mb-5 bg-gray-100 rounded-lg p-1 w-fit">
                            <button @click="tab = 'copy'"
                                    ...
                                    class="text-xs font-semibold px-3 py-1.5 rounded-md transition-all cursor-pointer">Draft copy</button>
                            <button @click="tab = 'image'"
                                    :class="tab === 'image' ? 'bg-white shadow-sm text-gray-900' : 'text-gray-500 hover:text-gray-700'"
                                    class="text-xs font-semibold px-3 py-1.5 rounded-md transition-all cursor-pointer">Social image</button>
                        </div>
                        ...
                        <div x-show="tab === 'image'" style="display: none;">
                            ...
                            <p class="text-xs text-gray-400 mt-3">Preview uses placeholder layout. Live output generated by wolf2-design-system skill.</p>
                        </div>
