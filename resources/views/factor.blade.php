...
<section class="bg-[#0D0F2B] text-white py-20 px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-start gap-6">
            ...
            <div>
                <p class="text-[#FF5F36] text-sm font-semibold uppercase tracking-wider mb-2">Factor {{ $number }} of 7</p>
                <h1 class="text-4xl md:text-5xl font-bold mb-4 leading-tight">{{ $factor['name'] }}</h1>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="grid md:grid-cols-3 gap-12">
            ...
            <div class="md:col-span-2 space-y-8">
                ...
                <div class="bg-[#FFF8F6] border border-orange-200 rounded-2xl p-7">
                    <p class="text-xs font-semibold text-[#FF5F36] uppercase tracking-wider mb-3">Example</p>
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <nav class="space-y-1">
                        ...
                        <a href="{{ url('/factor/' . $n) }}"
                           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-colors {{ $n === $number ? 'bg-[#FF5F36] text-white font-semibold' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50' }}">
                            <span class="font-mono text-xs {{ $n === $number ? 'text-orange-200' : 'text-gray-400' }}">{{ $f['number'] }}</span>
                            {{ $f['name'] }}
                        </a>
                        @endforeach
                    </nav>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="{{ url('/factor/' . $rel) }}"
                           class="flex items-center gap-3 p-4 rounded-xl border border-gray-200 hover:border-[#FF5F36] hover:bg-[#FFF8F6] transition-colors group">
                            <span class="text-lg font-bold text-gray-300 group-hover:text-[#FF5F36] transition-colors">{{ $allFactors[$rel]['number'] }}</span>
                            <div>
...
{{-- CTA --}}
<section class="bg-[#0D0F2B] py-16 px-6 lg:px-8">
