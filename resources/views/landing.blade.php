...
<section class="bg-[#F4F2E3] py-24 px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-6 mb-12">
            ...
            <div class="rounded-2xl border-2 border-gray-200 p-8">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-10 h-10 rounded-xl bg-[#D3EEFA] flex items-center justify-center">
                        <svg class="w-5 h-5 text-[#083763]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                        </svg>
                    </div>
                    <div>
                        <p class="text-xs font-semibold text-[#1D60CA] uppercase tracking-wider">Layer 1</p>
            ...
            {{-- Deterministic layer --}}
            <div class="rounded-2xl border-2 border-[#67EADD] bg-[#E1FFEC] p-8">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-10 h-10 rounded-xl bg-[#67EADD] flex items-center justify-center">
                        <svg class="w-5 h-5 text-[#083763]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                        </svg>
                    </div>
                    <div>
                        <p class="text-xs font-semibold text-[#083763] uppercase tracking-wider">Layer 2</p>
        ...
        <div class="bg-white rounded-2xl p-8 text-center border border-[#E6E2D9]">
...
<section class="bg-[#F4F2E3] py-20 px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="space-y-3">
            ...
            <a href="{{ url('/factor/' . $n) }}" class="flex items-start gap-4 p-5 rounded-xl border border-gray-200 hover:border-[#67EADD] hover:bg-[#E1FFEC] transition-colors cursor-pointer group">
                <div class="w-5 h-5 rounded border-2 border-gray-300 group-hover:border-[#67EADD] shrink-0 mt-0.5 transition-colors"></div>
                <div>
        ...
        <p class="text-center text-gray-400 text-sm mt-8">This checklist is part of the open Seven Factors framework. <a href="#whitepaper" class="text-[#67EADD] hover:underline">Read the full white paper →</a></p>
    </div>
</section>
    ...
    <div class="max-w-5xl mx-auto">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <button @click="openModal('Download white papers', 'This would trigger a PDF download of the full Seven Factors white paper series — one deep-dive document per factor. Each covers architectural patterns, real-world examples, and implementation guidance. In production, gated behind a simple email capture form.')"
                            class="bg-[#67EADD] hover:bg-[#21DBC8] text-[#083763] font-semibold px-6 py-3 rounded-lg text-sm transition-colors text-center cursor-pointer">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <a href="{{ url('/factor/' . $n) }}" class="bg-white rounded-xl p-5 border border-gray-200 shadow-sm hover:border-[#67EADD] transition-colors">
                    <p class="text-xs font-semibold text-[#67EADD] mb-1">Factor {{ $factor['number'] }}</p>
...
<section class="bg-white py-20 px-6 lg:px-8 border-t border-gray-200">
    <div class="max-w-4xl mx-auto">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                <p class="text-xs font-semibold text-[#67EADD] uppercase tracking-wider mb-4">The ambition</p>
                <h2 class="text-3xl font-bold font-display text-gray-900 mb-5 leading-tight">The Twelve-Factor App defined how cloud-native apps should be built. We're trying to do the same thing for agents.</h2>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start gap-5 p-6 rounded-2xl bg-[#E1FFEC] border border-[#B3FEF7]">
                    <div class="w-12 h-12 rounded-xl bg-[#67EADD] flex items-center justify-center shrink-0 text-lg font-bold text-[#083763]">7</div>
                    <div>
                        ...
                        <p class="text-[#67EADD] text-xs mt-2 font-medium">Scope: How agents should interact with enterprise systems.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="bg-[#083763] py-20 px-6 lg:px-8">
    <div class="max-w-3xl mx-auto text-center">
        <h2 class="text-3xl font-bold font-display text-white mb-4">This is an industry conversation, not a Workato conversation.</h2>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button @click="openModal('Contribute to the framework', 'This would link to the CONTRIBUTING.md on the Seven Factors GitHub repository. The process: fork the repo, add your pattern or correction with real-world context, open a PR. The maintainers review for fit with the existing factors. Community contributions are how this becomes an industry standard rather than a Workato document.')"
                    class="bg-[#67EADD] hover:bg-[#21DBC8] text-[#083763] font-semibold px-8 py-3.5 rounded-lg transition-colors cursor-pointer">
