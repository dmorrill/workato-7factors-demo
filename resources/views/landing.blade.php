...
{{-- Hero --}}
<section class="bg-[#083763] bg-dot-pattern text-white py-24 px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-6 mb-12">
            ...
            <div class="rounded-2xl border-2 border-[#67EADD] bg-[#E1FFEC] p-8">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <p class="text-xs font-semibold text-[#67EADD] uppercase tracking-wider">Layer 2</p>
...
{{-- Seven Factors --}}
<section id="factors" class="bg-[#083763] bg-dot-pattern py-24 px-6 lg:px-8">
